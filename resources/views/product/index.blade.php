...
@section('content')
    ...
    <div class="flex justify-between">
        ...
        <div class="px-6 my-6">
            <a href="{{route('products.create')}}" class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                Добавить
                        ...
                        <td class="px-4 py-3 text-sm">
                            ...
                            >
                                <img
                                    ...
                                    src="{{$product->image ? asset('/storage/'.$product->image) : '/img/no-photo.png'}}"
                                    alt=""
                                    loading="lazy"
                                />
                            </div>
