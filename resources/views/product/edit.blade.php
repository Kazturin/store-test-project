...
@section('content')
    ...
    <div>
        <x-breadcrumbs :links="[['url'=>route('products.index'),'label'=>'Товары'],['label'=>'Редактировать товар']]"></x-breadcrumbs>
    </div>
    <div
    ...
    >
        ...
        <form action="{{ route('products.update',$product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-center w-64 mt-4 text-gray-500 bg-purple-600">
