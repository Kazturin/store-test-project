            ...
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <Menu as="div" class="ml-3 relative">
                <div class="flex">
                    ...
                    >
                        <div class="w-10">
                            <ShoppingCartIcon class="text-white block h-6 w-8"/>
                            <router-link :to="{name:'ShoppingCart'}" v-if="basket.length>0" class="cursor-pointer text-red-500 font-black -bottom-1 text-lg absolute">{{ basket.length }}</router-link>
                        </div>
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div class="pt-4 pb-3 border-t border-gray-700">
              <div class="flex items-center px-5">
                      <ShoppingCartIcon class="text-white block h-6 w-8"/>
                      <router-link :to="{name:'ShoppingCart'}" v-if="basket.length>0" class="cursor-pointer text-red-500 font-black text-lg">{{ basket.length }}</router-link>
              </div>
          </div>
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      basket: computed(() => store.state.shoppingCart),
      navigation,
      logout,
    };
  },
